function Trains = find_stim_train2(digArray, srate, LowHz)
...
intervalSec = round(diff(digArrayONs),2); % round to nearest 1ms
intervalSamp = diff(digArrayON); % sample between each stim
HzStim = 1./intervalSec; % calculate HZ of each stim
